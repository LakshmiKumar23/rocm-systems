...
enum hip_api_id_t {
  ...
  HIP_API_ID_hipGreenCtxCreate = 457,
  HIP_API_ID_hipGreenCtxDestroy = 458,
  HIP_API_ID_hipCtxFromGreenCtx = 459,
  HIP_API_ID_hipGreenCtxRecordEvent = 460,
  HIP_API_ID_hipGreenCtxStreamCreate = 461,
  HIP_API_ID_hipGreenCtxWaitEvent = 462,
  HIP_API_ID_hipStreamGetGreenCtx = 463,
  HIP_API_ID_LAST = 463,
