...
SPM (Streaming Performance Monitor) sampling service for GPU profiling is a profiling technique to periodically sample performance counters.
...
SPM allows streaming of counters at regular intervals which provides better granular insight into kernel execution. SPM sample value is associated with a GPU timestamp when it is sampled.  
